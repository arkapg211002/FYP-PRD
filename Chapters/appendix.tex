...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.9\textwidth]{App Images/05 Interface.png}  
...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.9\textwidth]{App Images/06 Interface.png}  
...
\begin{figure}[h!]  
    ...
    \caption{Result from Post Analysis}

...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.85\textwidth]{Images/LR Confusion Matrix.png}  
...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.75\textwidth]{Images/NB Confusion Matrix.png}  
...
\begin{figure}[h!]  
    \centering
    \includegraphics[width=0.75\textwidth]{Images/SVM Confusion Matrix.png}  

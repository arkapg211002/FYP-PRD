...
\begin{figure}[h!]  
    ...
    \caption{ROC AUC Curve for Ensemble Model}
...
\subsubsection{Logistic Regression, SVM, Naive Bayes, XGBoost, LSTM}
...
\begin{figure}[h!]  
    ...
    \caption{Confusion Matrix for multiple models in Ensemble Model}
    \label{dfdl1244883}  % Label for referencing the figure
\end{figure}
...
\begin{figure}[h!]  
    ...
    \caption{ROC AUC Curve for multiple models in ensemble model}
    \label{dfdl1244883}  % Label for referencing the figure
\end{figure}
...
\begin{figure}[h!]  
    ...
    \caption{Comparison of results from LR, NB, SVM, XGB, LSTM and Ensemble Model}
    \label{dfdl1244883}  % Label for referencing the figure
\end{figure}
